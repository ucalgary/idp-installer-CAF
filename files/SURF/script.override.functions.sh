...

{
			...
			metadataSigningKeyURL="https://engine.surfconext.nl/authentication/sp/certificate"

			# openssl x509 -noout -fingerprint -sha256 -in ./caf_metadata_verify.crt
			# SHA256 Fingerprint=
			mdSignerFingerSHA256="63:E5:6D:72:DB:79:C5:03:DB:2A:21:8B:3B:43:E7:89:57:47:87:DE:69:2C:DF:85:56:D9:01:A3:A0:25:14:D8"
